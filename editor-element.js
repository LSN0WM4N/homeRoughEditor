  ...
  <div id="panel" class="leftBox">
    <ul class="list-unstyled">
      ...
      <li><button class="btn btn-light shadow fully " id="node_mode"><i class="fa fa-2x fa-scissors"
            aria-hidden="true"></i></button></li>
      <br />
      <li><button class="btn btn-light shadow fully " id="distance_mode" data-toggle="tooltip" data-placement="right"
      ...
      <li><button class="btn btn-light shadow fully " id="object_mode"
          onclick="$('.sub').hide();$('#energy_list').toggle(200);">ENERGY</button></li>
      <!-- <li><button class="btn btn-light shadow fully " id="object_mode" onclick="$('.sub').hide();$('#object_list').toggle(200);">FURNITURE</button></li> -->
      <br />

      <li><button class="btn btn-light shadow fully " id="layer_mode"
          onclick="$('.sub').hide();$('#layer_list').toggle(200);">Layers</button></li>
